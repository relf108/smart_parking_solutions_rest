...
class SmartParkingSolutionsRestChannel extends ApplicationChannel {
  ...
  Controller get entryPoint {
    ...
    router.route("/googleSignIn").linkFunction((request) async {
      final client = HttpClient(context: Sec);
      await client.postUrl(Uri.parse(
          'https://accounts.google.com/o/oauth2/v2/auth?response_type=code&redirect_uri=http://127.0.0.1:8888/createUser&client_id=${Credentials.clientID}'));
